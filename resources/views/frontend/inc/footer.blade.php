        ...
        <!--div class="row no-gutters">
            ...
            <div class="col-lg-3 col-md-6">
                <a class="text-reset border-left text-center p-4 d-block" href="{{ route('supportpolicy') }}">
                    ...
                    <h4 class="h6">{{ translate('Support / Disclaimer') }}</h4>
                </a>
            </div>
            <div class="col-lg-3 col-md-6">
                <a class="text-reset border-left border-right text-center p-1 d-block" href="{{ route('privacypolicy') }}">
                    <i class="las la-exclamation-circle la-3x text-primary mb-2"></i>
                    <h6 class="h6">{{ translate('Privacy Policy') }}</h6>
                </a>
            </div>
        </div>
    </div-->
...
<section class="bg-light py-5 " style="background-color: #93c353 !important;color: white;">
    <div class="container">
        <div class="row">
                ...
                <div class="mt-4">
                    <a href="{{ route('home') }}" class="d-block">
                        @if(get_setting('footer_logo') != null)
                            <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" height="80">
                        @else
                            <img class="lazyload" src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ static_asset('assets/img/logo.png') }}" alt="{{ env('APP_NAME') }}" height="80">
                        @endif
                    </a>
                    <div class="my-3">
                        @php
            ...
            <div class="col-lg-3 ">
                <div class="text-center text-md-left mt-4">
                    <h4 class="fs-13 text-normal fw-600 border-bottom border-gray-900 pb-2 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2">
                           <span class="d-block ">{{translate('Phone')}}:
                                <a href="tel:{{ get_setting('contact_phone') }}" class="text-reset">{{ get_setting('contact_phone')  }}</a>
                             
                               </span>
                        </li>
                        <li class="mb-2">
                          <span class="d-block ">  {{translate('Email')}}:  <a href="mailto:{{ get_setting('contact_email') }}" class="text-reset">  {{ get_setting('contact_email')  }}</a> </span>
             ...
             <div class="col-md-3 col-lg-3 ">
                <h5>Get The Android App </h5>
                
                <div class="text-left text-md-left mt-4">
                    <img width="100" class="rounded" src="{{static_asset('assets/img/qrcode.png')}}" ><br>
                    <img width="150px" class="rounded mt-2" src="{{static_asset('assets/img/googleplay.png')}}" >

                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <div class="mt-3" >
                                @if ($qty > 0)
                                    <button style="background-color:#93c353 !important" type="button" class="btn btn-soft-primary mr-2 add-to-cart fw-600" onclick="addToCart()">
                                        <i class="las la-shopping-bag"></i>
                                        <span  class="d-none d-md-inline-block"> {{ translate('Add to cart')}}</span>
                                    </button>
                                    <button style="background-color:#93c353 !important" type="button" class="btn  buy-now fw-600" onclick="buyNow()">
                                        <i class="la la-shopping-cart"></i> {{ translate('Buy Now')}}
                                    </button>
                                @else
                                    <button style="background-color:#93c353 !important" type="button" class="btn  fw-600" disabled>

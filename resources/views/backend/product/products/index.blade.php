        ...
        <table class="table aiz-table mb-0">
            <thead>
                <tr>
                    ...
                    @endif
                    <th data-breakpoints="lg">{{translate('Num of Sale')}}</th>
                ...
                @foreach($products as $key => $product)
                    <tr>
						...
						<td class="text-right">
                           ...
                           <a href="{{route('discount.configs', $product->id)}}"style="color:white" class="btn btn-warning btn-sm"  title="{{ translate('Discount') }}">
                              Discount

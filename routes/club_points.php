...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::post('point-convert/store', 'ClubPointController@convert_rate')->name('point_convert_rate');
    Route::post('tk-convert/store', 'ClubPointController@convert_tk')->name('tk_convert_point');
    Route::post('discount/store', 'ClubPointController@discountadd')->name('discount.add');
    
    
    
    
     Route::get('points/configuration', 'ClubPointController@pointconfigure_index')->name('points.configs');
     
     Route::get('/discount/config/{id}', 'ClubPointController@discount_index')->name('discount.configs');
     Route::get('/discount/edit/{id}','ClubPointController@discount_edit')->name('ajaxproducts.index');
     Route::post('/discount/update','ClubPointController@discount_update')->name('discount.update');
     Route::post('/discount/delete','ClubPointController@discount_delete')->name('discount.delete');
